...
throw new Error("Module build failed (from ./node_modules/postcss-loader/src/index.js):\nSyntaxError\n\n(37:3) `@apply` cannot be used with `.border-b-1` because `.border-b-1` either cannot be found, or its actual definition includes a pseudo-selector like :hover, :active, etc. If you're sure that `.border-b-1` exists, make sure that any `@import` statements are being properly processed *before* Tailwind CSS sees your CSS, as `@apply` can only be used for classes in the same CSS tree.\n\n  35 | }\n  36 | .tab-min {\n> 37 |   @apply outline-none font-bold px-4 py-1 border-b-1 border-gray-200;\n     |   ^\n  38 | }\n  39 | .tab-min-active {\n");
...
/******/ });
//# sourceMappingURL=application-05f4cce7bdb206be7cac.js.map